...
public interface IController {
   ...
   *
   * @throws InvalidCellException if the given cell coordinates do not exist within the Sudoku grid.
   * @throws InvalidValueException if the given value exceeds the size of the Sudoku grid.
   * @throws GivenCellException if the given cell stores a given value: these cannot be overwritten.
   *
   * @see sudoku.ISudokuGrid
   */
   ...
   *
   * <p>The algorithm will never place a hint in a cell in which the player has placed a value which
   * is already correct.
   *
   * @throws GridSolvedException if the grid has already been solved: there are no more cells left
   *     to hint.
   */
